...
// si no manejamos el controlador asincrono mediante el asyncHandler si este emite un, entoncess no podra ser manejado por el 
//errorHandler de nuestro proyecto
categoriaRouter
  .route('/categorias')
